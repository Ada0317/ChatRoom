...
public class UserModel {
    ...
    public UserInfo getUserByJK(int JK) throws SQLException {
		...
		byte[] bodyCount = new byte[collectionCount];// ÿ���ж��ٸ���
		int bodyNum[][] = new int[collectionCount][];// ÿ�����ѵ�JK��
		int bodypic[][] = new int[collectionCount][];//����ͷ��
		String bodyName[][] = new String[collectionCount][];// ÿ�����ѵ��ǳ�
